...
import BuyTodayCta from '../components/BuyTodayCta.js';
...
export default function Commercial({ pageData }) {

    const buyTodayCta = pageData.global_sections[5];
    ...
    return (
        ...
        <div dangerouslySetInnerHTML={{__html: pageData.yoast_head[0]}}>
            ...
            <TrustUsSection>
                <h2>{pageData.acf.customers_who_trust_us_section.title}</h2>
                <div className="trust-logos">
                    {pageData.acf.customers_who_trust_us_section.client_logos.map((item) => {
                        return (
            ...
            <ContentBoxWrapper>
                {pageData.acf.content_boxes.content_box.map((item) => {
            ...
            >
                ...
                <BuyTodayCta buyTodayCta={buyTodayCta}></BuyTodayCta>
